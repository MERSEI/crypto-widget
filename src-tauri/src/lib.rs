...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            futures::commands::place_futures_order,
            futures::commands::close_futures_position,
            futures::commands::cancel_futures_order,
            futures::commands::set_futures_leverage,
            futures::commands::set_futures_margin_type,
            futures::commands::get_futures_order_history,
